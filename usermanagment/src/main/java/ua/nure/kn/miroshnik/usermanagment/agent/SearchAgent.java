package ua.nure.kn.miroshnik.usermanagment.agent;
...
import ua.nure.kn.miroshnik.usermanagment.agent.exception.SearchException;
    ...
    public void search(String firstName, String lastName) throws SearchException {
        try {
            ...
            if (users.size() > 0) {
                ...
                addBehaviour(new SearchReqestBehavior(aids, firstName, lastName));
            }
